...
Inspired by the 1988 Digidesign TurboSynth. It mangles a sample or live
audio input into degraded, industrial textures: the signal runs through
waveshaping, AM/RM/FM modulation, a filter stack, a resonator, a spectral
inverter, delay, three envelopes, and 6-voice mono/poly/unison playback,
with bit-depth reduction along the way. A "tape" loop lets you bounce the
...
Built plugins land under `plugin/build/Broken_artefacts/`; the build
